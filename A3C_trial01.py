...
def data_func(net, device, train_queue):
    ...
    agent = a3c_utils.PolicyAgent(
        lambda x: net(x)[0], device=device, apply_softmax=True)
    exp_source = a3c_utils.ExperienceSourceFirstLast(
...
if __name__ == "__main__":
    ...
    try:
        with a3c_utils.RewardTracker(writer, REWARD_BOUND) as tracker:
            with a3c_utils.TBMeanTracker(
